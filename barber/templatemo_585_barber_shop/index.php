                ...
                <div class="col-md-8 ms-sm-auto col-lg-9 p-0">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-12 mx-auto">
                                <form action="create.php" method="post" class="custom-form booking-form" id="bb-booking-form" role="form">
                                    ...
                                    <div class="booking-form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <input type="tel" class="form-control" name="phone" placeholder="Mobile 010-020-0340" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required="">
                                            </div>
